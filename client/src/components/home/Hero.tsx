...
function Hero() {
    ...
    <div className="flex flex-col md:flex-col lg:flex-row">
        {/* Phần text */}
        <div className="w-full flex-auto order-1">
            <div className="py-[40px] text-left px-[14px]">
                ...
                <h1 className="font-cardo font-bold text-[40px] md:text-[55px] lg:text-[60px] leading-[50px] md:leading-[70px] lg:leading-[81px] mb-[10px] text-primary-800">
                ...
                <div className="flex flex-wrap justify-start gap-y-[30px] gap-x-[18px]">
                    ...
                    <div className="flex flex-col gap-[10px] pt-1 text-left">
        ...
        {/* Phần hình ảnh */}
        <div className="w-full flex-auto order-2">
            <div className="relative max-w-[480px] mx-auto mt-[20px] md:mt-[30px]">
