...
const reviews = [
    {
        ...
        content:
            'The course was structured really well, and the instructor explained concepts clearly. Highly recommended!'
    },
    {
        id: 2,
        name: 'Daniel Lee',
        ...
        content:
            'I learned a lot from this course. Some parts could have been more detailed, but overall a great experience.'
    },
    {
        id: 3,
        name: 'Jessica Adams',
        ...
        content:
            'The instructor is very knowledgeable and provides great real-world examples. Will definitely enroll in more courses!'
    },
    {
        id: 4,
        name: 'Michael Brown',
    ...
    },
    {
        ...
        content:
            'I struggled at first, but after completing this course, I feel much more confident in my coding skills.'
    }
];
        ...
        <div className="px-10 py-10 ml-auto max-w-[1000px] border-[1px] border-primary-100 rounded-xl">
            <div className="border-b flex items-center justify-between gap-5 pb-8">
                ...
                <div className="flex-grow">
                    <h6 className="text-[22px] font-medium leading-[28px]">Student Reviews</h6>
                </div>

                {/* SortBy - Căn bên phải với khoảng cách đều hai bên */}
                <div className="ml-auto right-0">
                    {' '}
                    {/* Thêm ml-auto để đẩy SortBy sang bên phải */}
