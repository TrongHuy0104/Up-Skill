            ...
            <div className="bg-primary-50 rounded-lg p-[34px] border border-primary-100">
                ...
                <div className="overflow-x-auto">
                    <table className="w-full">
                        ...
                        <tbody>
                            {bestSellingCourses.slice((currentPage - 1) * 4, currentPage * 4).map((course: any) => (
                                <tr key={course._id} className="border-b border-primary-100">
                                    ...
                                    <td className="py-4 pl-6">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <button className="p-2 rounded-xl group border border-primary-100 hover:bg-accent-900 transition-colors duration-200">
                                                <div className="relative w-4 h-4">
                                                    <Image
