    ...
    return (
        <div>
            ...
            <Banner title="Shop Cart" breadcrumbs={breadcrumbsData1} contentAlignment="center">
                <h6 className="text-primary-800">Products that help beginner designers become true unicorns.</h6>
            </Banner>

            {/* Web Development banner */}
            <Banner title="Web Development Courses" breadcrumbs={breadcrumbsData2} contentAlignment="left">
                <p className="text-gray-600 mb-6">
                    With one of our online web development courses, you can explore different areas of this in-demand
                    field.
                </p>
            ...
            >
                ...
                <div className="author-item">
                    <div className="author-item-img">
                        <img
                            src="https://creativelayers.net/themes/upskill-html/images/page-title/inner-page.png"
                            alt="Author"
