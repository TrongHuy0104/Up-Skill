...
const ShopCart: React.FC = () => {
    ...
    return (
        <div className="max-w-full mx-auto">
            ...
            <Banner
                title="Shop Cart"
                breadcrumbs={[{ href: '/', text: 'Home' }, { href: '', text: 'Page' }, { text: 'Shop' }]}
                    ...
                    {filteredCartItems.length === 0 ? (
                        <div className="w-full flex justify-center">
                            <div className="flex flex-col items-center justify-center py-2">
                                {/* Empty Cart Image */}
                                <Image src={empty} alt="Empty Cart" width={180} height={180} priority />
                                <p className="text-center text-primary-800 font-medium text-xl">Your cart is empty</p>
                                <Link
                                    href="/courses"
                                    className="mt-4 bg-primary-800 text-primary-50 px-6 py-3 rounded-md hover:bg-accent-900 flex items-center justify-center gap-2 text-base font-medium"
                                >
                                    Back to Course page
                                </Link>
                            </div>
                                        ...
                                        <tbody>
                                            {filteredCartItems.map((item) => (
                                                <tr key={item._id} className="border-b">
                                                    ...
                                                    <td className="py-4 px-4 text-sm text-primary-800">
                                                        ${item.courseId.price?.toFixed(2) || 'N/A'}
                                                    </td>
