...
export default function CourseContentList({ data, progressData, activeVideo, setActiveVideo, onQuizClick }: Props) {
                                        ...
                                        >
                                            <span className="flex items-center gap-2">
                                                ...
                                                <button
                                                    ...
                                                    onClick={() => {
                                                        if (isQuiz) {
                                                            console.log('Quiz clicked, quizId:', item.quizzes[0]._id); // In ra quizId để kiểm tra
                                                            onQuizClick(item.quizzes[0]._id); // Gọi hàm xử lý click vào quiz
                                                        } else {
